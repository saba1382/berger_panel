                ...
                <div >
                    <form onSubmit={handleSubmit} className={styles.form}>
                        <label className={styles.labelInput}>
                            Name of the product
                            <Input type="text" name='title' onChange={(e) => formState.title=e.target.value}/>
                        </label>
                        <label className={styles.labelInput}>
                            Ingredients
                            <div className={styles.input_tag}>
                                <InputTag ingredients={(e:any) => formState.Ingredients=e}/>
                            </div>
                        </label>
                        <Checkbox onChange={(e) => formState.see=e.target.checked}>Suitable for vegans</Checkbox>
                        <div className={styles.form_box}>
                            <label className={styles.labelInput}>
                                Weight in grams
                                <Input type="number" name='weight' onChange={(e) => formState.weight=e.target.value}/>
                            </label>
                            <label className={styles.labelInput}>
                                Calories
                            ...
                            <label className={styles.labelInput}>
                                Price
                                <Input type="number" name='price' onChange={(e) => formState.price=e.target.value} prefix={'$'}/>
                            </label>
                            <div className={styles.upload_image}>
                                ...
                                <Upload accept='image/png, image/jpg'  onChange={(e) => console.log('object img', e)}>
                                    <Button icon={<UploadOutlined />} className={styles.upload_btn}>Choose photo</Button>
                                </Upload>
                            </div>
                        </div>
                        <button type="submit" className={styles.btn_submit}><PlusOutlined /> Add product to the menu!</button>
                    </form>
                </div>
            </Drawer>
        </div>
